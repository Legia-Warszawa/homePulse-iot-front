...
class _InteractiveRoomChartState extends State<InteractiveRoomChart> {
  ...
  // Zmieniamy nazwę na filteredRoomData
  List<EspRoom1> filteredData = []; 

  // Zmienne X przechowują TIMESTAMPY (milisekundy od Epoki)
  late double minX;
  late double maxX;
  double minY = 20; // Wartość startowa dla Y
  double maxY = 26; // Wartość startowa dla Y
  ...
  void _filterDataAndInitializeLimits() {
    // 1. Filtracja
    filteredData = widget.roomData.where((d) { // Używamy roomData
  ...
  // --- FUNKCJA Formatująca Tytuły na Osi X (Używa intl) ---
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Temperatura - Pokój (Wizualizacja Czasowa)', // Zmieniony tytuł
                              ...
                              getTooltipItems: (spots) {
                                return spots.map((spot) {
                                  ...
                                  return LineTooltipItem(
                                    // Używamy spot.y bo to jest wartość temperatury
                          ...
                          lineBarsData: [
                            LineChartBarData(
                              spots: filteredData
                                  ...
                                  .toList(),
                              isCurved: true,
                              color: Colors.blue, // Zmieniony kolor na niebieski dla pokoju
                              barWidth: 2,
